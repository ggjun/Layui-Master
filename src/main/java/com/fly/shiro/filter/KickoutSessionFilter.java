...
import com.fly.basic.api.IStatusMessage;
import com.fly.user.domain.FlyUser;
import com.fly.util.ResponseResult;
import com.fly.util.ShiroFilterUtils;
...
public class KickoutSessionFilter extends AccessControlFilter {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response)throws Exception {
        ...
        try{
            ...
            String username = user.getSys_user_name();
            logger.info("===当前用户username:" + username + "===当前请求的uri:" + path);
