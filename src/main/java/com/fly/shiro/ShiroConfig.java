...
import com.fly.shiro.filter.KickoutSessionFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        /*filterMap.put("/", "user");*/
        //配置认证通过才可以访问的地址
        filterMap.put("/flyuser/setUser", "authc");
        filterMap.put("/flyrole/setRole", "authc");
        filterMap.put("/flypermission/setPermission", "authc");
        ...
        filterMap.put("/flyuser/login", "anon");
        //新增放行请求
        filterMap.put("/company/index", "anon");
        filterMap.put("/company/case", "anon");
        filterMap.put("/company/service", "anon");
        filterMap.put("/company/about", "anon");
        filterMap.put("/company/details", "anon");
        
        filterMap.put("/blog/index", "anon");
        filterMap.put("/blog/about", "anon");
        filterMap.put("/blog/album", "anon");
        filterMap.put("/blog/details", "anon");
        filterMap.put("/blog/leacots", "anon");
        filterMap.put("/blog/whisper", "anon");
        filterMap.put("/filecontroller/readAttach", "anon");
        //个人博客
        filterMap.put("/myblog/index", "anon");
        //新增放行资源目录
        filterMap.put("/layuiSimpleBlog/*", "anon");
        filterMap.put("/layuiSimpleBlog/*/*", "anon");
        filterMap.put("/layuiSimpleBlog/*/*/*", "anon");
        filterMap.put("/layuiUniversalCompany/*", "anon");
        filterMap.put("/layuiUniversalCompany/*/*", "anon");
        filterMap.put("/layuiUniversalCompany/*/*/*", "anon");

        filterMap.put("/myBlog/*", "anon");
        filterMap.put("/myBlog/*/*", "anon");
        filterMap.put("/myBlog/*/*/*", "anon");
